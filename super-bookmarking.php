...
$bwidget .= '<a rel="nofollow" onclick="javascript:window.open(\''.$data.'\'); return false;" href="http://www.'.$site.'.com/" title="'.$site.'"><img src="'.$site_url.'/wp-content/plugins/super-bookmarking/images/'.$site.'.gif" alt="'.$site.'" ></a> | ';
}
